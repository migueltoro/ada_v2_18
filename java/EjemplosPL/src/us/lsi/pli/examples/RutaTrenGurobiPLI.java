...
public class RutaTrenGurobiPLI {
	...
	public static String getContraints() {
		...
		r.append(goalMin(sum_2(n,n,"x",pd,costes)));
		r.append("\nSubject To\n\n");
		r.append(constraintEq(sum_2_2_p(n,0,"x",pd)," 1\n",0,"a"));
		r.append(constraintEq(sum_2_1_p(n,n-1,"x",pd)," 1\n",1,"a"));
		r.append(forAll_1_r(1,n-1, 
				i->constraintEq(String.format("%s + %s",
						sum_2_1_p(n,i,"x",pd),
						sum_2_2(n,i,"x",pd,(k,j)->"-1")),
						" 0",i,"b")));
		r.append("\nBinary\n\n");
