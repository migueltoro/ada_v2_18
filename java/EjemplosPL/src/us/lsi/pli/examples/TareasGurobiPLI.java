...
import static us.lsi.gurobi.AuxiliaryGurobi.all1;
import static us.lsi.gurobi.AuxiliaryGurobi.constraintLe;
import static us.lsi.gurobi.AuxiliaryGurobi.forAll_2;
import static us.lsi.gurobi.AuxiliaryGurobi.goalMax;
import static us.lsi.gurobi.AuxiliaryGurobi.sum_1;
import static us.lsi.gurobi.AuxiliaryGurobi.varId_1;
import static us.lsi.gurobi.AuxiliaryGurobi.vars_1;
...
public class TareasGurobiPLI {
	...
	public static String getConstraints() {
		...
		r.append(goalMax(sum_1(n,"x",all1,i->Tarea.tareas.get(i).ganancia.toString())));
		r.append("\nSubject To\n");
		r.append(forAll_2(n,n,
				(i,j)->j>i && Tarea.solape(i,j)>0, 
				(i,j)->constraintLe(String.format("%s + %s",varId_1("x",i),varId_1("x",j))," 1",n*i+j,"c")));
		r.append("\nBinary\n\n");
		r.append(vars_1(n,"x"));
		return r.toString();
	}
