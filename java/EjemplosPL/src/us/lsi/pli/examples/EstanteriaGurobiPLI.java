...
public class EstanteriaGurobiPLI {
	...
	public static String getConstraints() {
		...
		r.append(goalMax(sum_2_v(n,m,"x")));
		r.append("\nSubject To\n\n");
		r.append(forAll_2(n,m,(i,j)->constraintLe(
							String.format("%s %s",Libro.altura(i),varId_2("x",i,j)),
							Estante.altura(j),i*n+j,"a")));
		r.append(forAll_1(m,j->constraintLe(
							sum_2_1_f(n,j,"x",(i,x)->Libro.anchura(i)),
							Estante.anchura(),j,"b")));
		r.append(forAll_1(n,i->constraintEq(
							sum_2_2_v(m+1,i,"x"),
							" 1",i,"c")));
		r.append("\nBinary\n\n");
