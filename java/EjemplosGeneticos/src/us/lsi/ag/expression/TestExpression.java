...
public class TestExpression {
	...
	public static void main(String[] args) {
		...
		AlgoritmoAG<ExpressionChromosome<Double>> ap = AlgoritmoAG.create(ChromosomeFactory.ChromosomeType.Expression,p);
		ap.ejecuta();
		
		ExpressionChromosome<Double> cr = ap.getBestChromosome();
		System.out.println("================================");
