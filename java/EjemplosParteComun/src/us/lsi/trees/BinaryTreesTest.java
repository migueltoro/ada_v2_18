...
public class BinaryTreesTest {
	...
	public static <E> Boolean equals(BinaryTree<E> t1, BinaryTree<E> t2) {
		return switch (t1) {
		case BEmpty<E>  r1 && t2 instanceof BEmpty<E> r2 -> true;
		case BLeaf<E>  r1 && t2 instanceof BLeaf<E> r2 &&  r1.label().equals(r2.label()) -> true;
		case BTree<E>  r1 && t2 instanceof BTree<E> r2 && r1.label().equals(r2.label()) ->
	...
	public static Boolean existeLista(BinaryTree<Character> tree, List<Character> ls) {
		Integer n = ls.size();
		return switch (tree) {
		case BEmpty<Character> t && ls.isEmpty() -> true;
		case BLeaf<Character> t && !ls.isEmpty() -> ls.get(0).equals(t.label());
		case BTree<Character> t && !ls.isEmpty() -> ls.get(0).equals(t.label())
