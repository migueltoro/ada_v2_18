...
public class TestRecta {
	...
	public static void main(String[] args) {
		...
		Recta2D r2 = Recta2D.create(Punto2D.of(1., 1.), Vector2D.createCartesiano(1., 1.));
		Recta2D r3 = Recta2D.create(Punto2D.of(2., 2.), Vector2D.createCartesiano(-1., -1.));
		...
		System.out.println(Vector2D.createCartesiano(1., 1.).getAnguloEnGrados());
		System.out.println(Vector2D.createCartesiano(-1., 1.).getAnguloEnGrados());
		System.out.println(Vector2D.createCartesiano(-1., -1.).getAnguloEnGrados());
		System.out.println(Vector2D.createCartesiano(1., -1.).getAnguloEnGrados());
