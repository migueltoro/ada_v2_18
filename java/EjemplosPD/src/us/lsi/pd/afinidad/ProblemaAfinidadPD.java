...
public class ProblemaAfinidadPD  implements 
	ProblemaPDR<SolucionAfinidad, Integer, ProblemaAfinidadPD> {
	...
	private ProblemaAfinidadPD() {
		this.indexCliente=0;
		this.numClientesPorTrabajador= Lists2.copy(ProblemaAfinidad.trabajadores.size(), 0);
	...
	@Override
	public ProblemaAfinidadPD getSubProblema(Integer a) {		
