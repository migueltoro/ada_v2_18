...
public class NumeroDeArbolesNArios implements ProblemaPD<Integer, Integer,NumeroDeArbolesNArios> {
	...
	@Override
	public NumeroDeArbolesNArios getSubProblema(Integer a, int np) {
