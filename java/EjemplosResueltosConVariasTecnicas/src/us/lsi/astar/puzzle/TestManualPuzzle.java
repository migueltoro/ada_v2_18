...
public class TestManualPuzzle {
	...
	public static void test2() {
		...
		AStarGraph<VertexPuzzle,SimpleEdgeAction<VertexPuzzle,ActionPuzzle>> graph =  AStarSimpleVirtualGraph.of(x->1.);
		RecorridoAStarManual<VertexPuzzle,SimpleEdgeAction<VertexPuzzle,ActionPuzzle>> a = RecorridoAStarManual.of(graph,e1,e2,(x,y)->(double)x.getNumDiferentes(y));
