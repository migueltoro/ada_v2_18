...
public class LpSolve {
	 ...
	 * @return Crea que problema a resolver
	 */
	 ...
	 * @param verbose Tipo de descripción 
	 * @param lpName Nombre del fichero
	 * @return Problema creado a partir del fichero
	 * @throws LpSolveException Excepción que se puede disparar
	 */
	...
	*/
	...
	private static synchronized void addLp(LpSolve problem) {
		lpMap.put(Long.valueOf(problem.lp), problem);
	}
	...
	private static synchronized LpSolve getLp(long lp) {
		return (LpSolve)lpMap.get(Long.valueOf(lp));
	}
